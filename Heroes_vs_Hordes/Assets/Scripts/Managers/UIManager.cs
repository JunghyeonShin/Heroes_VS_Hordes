...
public class UIManager
{
    ...
    private const int INDEX_UI_SELECT_HERO = 5;
    private const int INDEX_UI_COIN_RUSH_WAVE = 6;
    private const int INDEX_UI_COIN_BOSS_BATTLE_WAVE = 7;
    private const int INDEX_UI_ABILITY = 8;
    private const int INDEX_UI_SELECT_ABILITY = 9;
    ...
    private void _InstantiateEssentialUI()
    {
        ...
        _InstantiateUI<UI_SelectHero>(Define.RESOURCE_UI_SELECT_HERO, () => { _loadCompletes[INDEX_UI_SELECT_HERO] = true; });
