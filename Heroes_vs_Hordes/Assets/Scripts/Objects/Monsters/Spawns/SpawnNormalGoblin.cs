...
public class SpawnNormalGoblin : SpawnMonster
{
    ...
    private async UniTaskVoid _Spawn()
    {
        ...
        for (int ii = 0; ii < _spawnMonsterCount; ++ii)
            MonsterSpawner.RegistSpawnMonster(UnityEngine.Random.Range(0, MonsterSpawner.SpawnPointTotalIndex), Define.RESOURCE_MONSTER_NORMAL_GOBLIN);
