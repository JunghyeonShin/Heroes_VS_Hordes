...
public class TestHeroController : MonoBehaviour
{
    ...
    public void SetAbility()
    {
        ...
        var weaponAbility = Manager.Instance.Data.WeaponAbilityDataDic[Define.WEAPON_ARCANE_MAGE_PROJECTILE];
        var weaponLevelAbilityList = Manager.Instance.Data.WeaponLevelAbilityDataDic[Define.WEAPON_ARCANE_MAGE_PROJECTILE];
    ...
    public void StartNormalAttack()
    {
        ...
        testSceneUI.SetWeaponName(Define.WEAPON_ARCANE_MAGE_PROJECTILE);
    ...
    private async UniTaskVoid _AttackMonster(Vector3[] targetPositions)
    {
        ...
        for (int ii = 0; ii < targetPositions.Length; ++ii)
        {
            ...
            testProjectile.Init(initProjectilePos, targetPositions[ii], Attack, _projectileSpeed, _penetraitCount, _ReturnProjectile);
